...
public class QueryingStream extends Thread {
    ...
    public QueryingStream (Model gu, Reasoner r, Query q, Timer et, Timer t, 
                           Counter c, BufferedWriter i, String dir, Timer wrapperTimer, Timer graphCreationTimer, Counter ids, HashSet<Predicate> includedViewsSet, int timeout) {
        this.graphUnion = gu;
        this.reasoner = r;
        this.query = q;
    ...
    private void evaluateQuery() {
        ...
        if (this.counter.getValue() != this.lastValue) {
            ...
            if (query.isSelectType()) {
                evaluateSelectQuery(result, fileName, id, tempValue);
    ...
    private void evaluateSelectQuery(QueryExecution result, String fileName, int id, int tempValue) throws java.io.IOException {
