...
public class executionMCDSATThreaded {
        ...
        try {
            ...
            if (JOIN_TYPE.equals("GUN")) {
                executeGUNWholeAnswer(PATH, ONTO, QUERY_RESULTS_PATH, query, catalog, 
                        ...
                        conjunctiveQuery, mappings, t, numViews, file);
    ...
    public static void executeJENAWholeAnswer(final String PATH, final String ONTO,  
                                             ...
                                             int numViews, String dir) throws Exception {
        String line;
        ...
        numberTimer.start();
        Process p = startRewriter(PATH + mappings, conjunctiveQuery, t, codePath);
    ...
    public static Process startRewriter(String mappingsFile, String queryFile, int t, String codePath) throws Exception {
        List<String> l = new ArrayList<String>();
        l.add("timeout");
        l.add(t+"m");
        l.add(codePath + "/mcdsat/mcdsat/mcdsat");
        //l.add("-t");
        l.add("RW");
        //l.add("-v");
        l.add(mappingsFile);
    ...
    public static void executeGUNWholeAnswer(final String PATH, final String ONTO,  
        ...
        Thread tquery = new QueryingStream(graphUnion, reasoner, query, 
                            ...
                            graphCreationTimer, ids, includedViewsSet, t);
