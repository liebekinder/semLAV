...
for setup in $SETUPS ;do
    ...
    for i in $QUERIES ;do
        ...
        timeout 30m java -XX:MaxHeapSize=2048m -cp ".:../lib2/*" experimentseswc/Main
    ...
    java processResultsChainGUNThreaded $GUNPATH/code/expfiles/berlinOutput/${setup}/ outputquery $GUNPATH/code/expfiles/berlinOutput/${setup}/resultsGUNMCDSAT${setup}.dat $GUNPATH/code/expfiles/berlinData/answersSize
done
